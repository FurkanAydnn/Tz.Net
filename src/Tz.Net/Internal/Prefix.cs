namespace TezosSharp.Internal
{
    public static class Prefix
    {
        ...
        public static readonly byte[] edsk2 = { 13, 15, 58, 7 };
        ...
        public static readonly byte[] spsig1 = { 13, 115, 101, 19, 63 };
        public static readonly byte[] p2sig = { 54, 240, 44, 52 };
        public static readonly byte[] sig = { 4, 130, 43 };
        ...
        public static readonly byte[] Co = { 79, 179 };
        public static readonly byte[] id = { 153, 103 };
    }
}